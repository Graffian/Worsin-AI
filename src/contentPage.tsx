...
export default function ContentPage():JSX.Element{
    ...
    return (
    <>
        <div className="w-[360px] h-[420px] fixed right-0 bottom-0 bg-[#33333399] backdrop-blur-[6px] text-white overflow-y-auto
                        rounded-t-2xl shadow-current">
            ...
            <div className="py-4 px-2 flex flex-col flex-nowrap flex-grow min-h-full">
                <div className="px-4 bg-blue-300 text-black rounded-full w-[50%] right-0">{userMsg}</div>
                <div className="px-4 bg-gray-300 text-black rounded-full w-[50%] right-0">{aiMsg}</div>
            </div>
